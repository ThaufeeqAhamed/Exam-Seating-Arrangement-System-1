...
def process_pdf_timetable(pdf_file) -> Tuple[List[Dict[str, Any]], List[str]]:
    ...
    import os
    poppler_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__)))), '.venv', 'poppler', 'poppler-23.11.0')
    if not os.path.exists(poppler_path):
        # Try alternative poppler path
        poppler_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__)))), 'poppler', 'poppler-23.11.0')
        if not os.path.exists(poppler_path):
